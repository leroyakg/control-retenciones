    ...
    <div className="flex flex-col gap-6 max-w-2xl">
      <div className="flex items-center gap-3">
        <Button asChild size="icon" variant="ghost">
          <Link href="/dashboard/empresas" title="Volver">
        ...
        <div>
          ...
          <p className="text-sm text-foreground/60">
            Registrá un nuevo negocio.
          </p>
        </div>
      </div>

      <form action={createMerchant} className="flex flex-col gap-5">
        <div className="flex flex-col gap-2">
          <Label htmlFor="nickname">Nombre</Label>
          <Input id="nickname" name="nickname" placeholder="Negocio 1" required />
        </div>
